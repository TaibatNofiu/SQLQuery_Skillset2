...
DROP DATABASE IF EXISTS CommercialDB;
...
CREATE TABLE PRODUCTS(
   ...
   CONSTRAINT FK_PRODUCTS_CATEGORIES FOREIGN KEY (CATEGORY_CODE) REFERENCES CATEGORIES (CATEGORY_CODE),
   CONSTRAINT FK_PRODUCTS_SUPPLIERS FOREIGN KEY (SUPPLIER_NUMBER) REFERENCES SUPPLIERS (SUPPLIER_NUMBER)
   );
...
CREATE TABLE ORDERS(
   ...
   CONSTRAINT FK_ORDERS_CUSTOMERS FOREIGN KEY (CUSTOMER_CODE) REFERENCES CUSTOMERS (CUSTOMER_CODE),
   CONSTRAINT FK_ORDERS_EMPLOYEES FOREIGN KEY (EMPLOYEE_NUMBER) REFERENCES EMPLOYEES (EMPLOYEE_NUMBER)
   );
...
CREATE TABLE ORDER_DETAILS(
   ...
   CONSTRAINT FK_ORDER_DETAILS_PRODUCTS FOREIGN KEY (PRODUCT_REF) REFERENCES PRODUCTS (PRODUCT_REF)
);
